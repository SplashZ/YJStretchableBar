Pod::Spec.new do |s|
  ...
  s.requires_arc = true
  s.source_files = "YJStretchableBarDemo/YJStretchableBarDemo/YJStretchableBar/*.{h,m}"
  s.public_header_files = 'YJStretchableBarDemo/YJStretchableBarDemo/YJStretchableBar/*.{h}'
end